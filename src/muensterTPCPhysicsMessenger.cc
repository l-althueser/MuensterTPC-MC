...
muensterTPCPhysicsMessenger::muensterTPCPhysicsMessenger(muensterTPCPhysicsList *pPhysicsList):
...
muensterTPCPhysicsMessenger::~muensterTPCPhysicsMessenger()
{
  delete m_pDirectory;
}

void
muensterTPCPhysicsMessenger::SetNewValue(G4UIcommand * command, G4String newValues)
{
