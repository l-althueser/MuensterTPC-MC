...
muensterTPCParticleSourceMessenger::muensterTPCParticleSourceMessenger(muensterTPCParticleSource *pParticleSource):
	m_pParticleSource(pParticleSource), m_bShootIon(false)
{
	m_pParticleTable = G4ParticleTable::GetParticleTable();
	m_pIonTable = G4ParticleTable::GetParticleTable()->GetIonTable();
...
void
muensterTPCParticleSourceMessenger::SetNewValue(G4UIcommand * command, G4String newValues)
{
